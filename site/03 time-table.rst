...
이번에는 업무 일정을 추가하는 방법을 알아보겠습니다. ``category`` 에 ``'task'`` 를 지정하면 업무 일정입니다. 업무 일정은 일간 뷰, 주간 뷰에서는 상단의 Task 패널에 따로 표시되며, 업무 일정을 클릭할 때 나타나는 팝업에서 편집도 가능합니다. 업무 일정도 다른 색상으로 표시해 보겠습니다.
